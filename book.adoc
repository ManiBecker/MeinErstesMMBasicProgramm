...
:revnumber: 0.21
:revdate: 2026-09-23
:github-programme: https://github.com/ManiBecker/MeinErstesMMBasicProgramm/blob/main/programme

ifndef::kdp[]
image::bilder/cover.jpg[pdfwidth=100%,align=center]
...
image::bilder/00_hallo.jpg[width=70%,align=center]
...
Dort stehen auch die BASIC-Programme und weitere Projektdateien zum
Download bereit.

Die aktuellste Version des PDFs zum Download, begleitende Informationen, 
Neuigkeiten und zusätzliche Beiträge zum Projekt finden sich auf der Webseite zum Tutorial.

Mein besonderer Dank gilt Geoff Graham, dem Entwickler von MMBasic, sowie
Peter Mather, der MMBasic für den Colour Maximite 2 und die PicoMite-Familie
entscheidend weiterentwickelt hat.

Ohne ihre jahrelange Arbeit und die frei verfügbaren Handbücher wäre dieses
Tutorial nicht möglich.

**Hinweis zur Entstehung des Tutorials**

Dieses Tutorial wurde vom Autor erstellt und wird kontinuierlich weiterentwickelt.

Bei der Ausarbeitung der Texte, der sprachlichen Überarbeitung sowie der Strukturierung einzelner Kapitel kamen Werkzeuge auf Basis generativer Künstlicher Intelligenz (KI) unterstützend zum Einsatz.

Alle fachlichen Inhalte, Programmbeispiele und technischen Aussagen wurden vom Autor ausgewählt, geprüft und für die Veröffentlichung freigegeben.

**Hinweis zu den Illustrationen**

Viele der Illustrationen in diesem Tutorial wurden mit Unterstützung generativer Künstlicher Intelligenz (KI) erstellt.

Die Bildideen, die fachlichen Inhalte sowie die Auswahl der endgültigen Illustrationen stammen vom Autor. Die KI wurde ausschließlich als Werkzeug zur Erstellung der Abbildungen eingesetzt.

Ziel war es, technische Sachverhalte anschaulich zu vermitteln und den Einstieg in MMBasic zu erleichtern.

<<<

:sectnums!:

include::kapitel/00-vorwort.adoc[]

<<<

include::kapitel/00-danksagung.adoc[]
...
include::anhang/anhang-a-mmbasic-funktionsreferenz.adoc[]
endif::[]
...
image::bilder/back.jpg[pdfwidth=100%,align=center]
