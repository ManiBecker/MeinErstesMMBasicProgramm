...
Print "Kapitel 4: Benutzereingaben mit INPUT"
Print
Print "Warum Benutzereingaben wichtig sind"
Print "A=10":A=10
Print "B=20":B=20
...
Print "Unsere erste Eingabe"
Print "Input A":Input A
Print "Print A":Print A

Print "Press any key...": Do : Loop While Inkey$=""

Print "Eingaben in Variablen speichern"
Print "Input A":Input A
Print "Print A":Print A

Print "Press any key...": Do : Loop While Inkey$=""

Print "Mit Eingaben rechnen"
Print "Input A":Input A
Print "Print A*2":Print A*2

Print "Press any key...": Do : Loop While Inkey$=""

Print "Zwei Werte eingeben"
