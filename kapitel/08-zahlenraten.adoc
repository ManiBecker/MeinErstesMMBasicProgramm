...
image::bilder/08_zahlenraten.jpg[align=center]
...
=== Programme als Dateien speichern

Bis jetzt haben wir immer mit dem Programm gearbeitet, das sich im PicoMite befindet.
Bei größeren Projekten ist es jedoch praktisch, mehrere Programme als Dateien zu speichern.

Mit dem Befehl indexterm:[Dateiverwaltung,SAVE]indexterm:[SAVE]`SAVE` speicherst du das aktuelle Programm unter einem Namen:

[source,basic]
----
SAVE "ZAHLENRATEN.BAS"
----

Mit indexterm:[Dateiverwaltung,FILES]indexterm:[FILES]`FILES` kannst du dir alle gespeicherten Dateien anzeigen lassen:
...
Um ein gespeichertes Programm später wieder zu laden, verwendest du indexterm:[Dateiverwaltung,LOAD]indexterm:[LOAD]`LOAD`:

[source,basic]
----
LOAD "ZAHLENRATEN.BAS"
----

Du kannst ein gespeichertes Programm auch direkt zum Bearbeiten öffnen:

[source,basic]
----
EDIT "ZAHLENRATEN.BAS"
----

Damit kannst du beliebig viele Programme aufbewahren und jederzeit weiterentwickeln.
...
* {github-programme}/08_zahlenraten.bas[08_zahlenraten.bas]
endif::[]
