...
Mit dem Befehl `SAVE` speicherst du das aktuelle Programm unter einem Namen:
...
Mit `FILES` kannst du dir alle gespeicherten Dateien anzeigen lassen:
...
Um ein gespeichertes Programm später wieder zu laden, verwendest du `LOAD`:
