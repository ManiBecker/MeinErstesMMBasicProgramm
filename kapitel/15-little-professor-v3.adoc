...
image::bilder/15_little_professor_v3.jpg[align=center]
...
* indexterm:[Fehleranalyse] Fehler analysieren
...
* {github-programme}/15_little_professor_v3.bas[15_little_professor_v3.bas]
* {github-programme}/15_little_professor_v3_final.bas[15_little_professor_v3_final.bas]
endif::[]
