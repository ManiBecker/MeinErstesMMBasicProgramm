...
Für solche Aufgaben eignet sich die indexterm:[DO...LOOP-Befehlsfamilie,DO]indexterm:[DO...LOOP-Befehlsfamilie,LOOP]indexterm:[DO]indexterm:[LOOP]Schleife `DO ... LOOP`.
...
Dieses Programm läuft als indexterm:[Endlosschleife]Endlosschleife und kann nur mit CTRL+C beendet werden.

=== Die Schleife beenden

Eine Schleife kann mit einer Bedingung beendet werden. Mit indexterm:[DO...LOOP-Befehlsfamilie,UNTIL]indexterm:[UNTIL]`UNTIL` wird die Schleife beendet, sobald die Bedingung erfüllt ist.
