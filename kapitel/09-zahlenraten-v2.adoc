...
Für solche Aufgaben eignet sich die indexterm:[DO]indexterm:[LOOP]Schleife `DO ... LOOP`.
...
Eine Schleife kann mit einer Bedingung beendet werden. Mit indexterm:[UNTIL]`UNTIL` wird die Schleife beendet, sobald die Bedingung erfüllt ist.
