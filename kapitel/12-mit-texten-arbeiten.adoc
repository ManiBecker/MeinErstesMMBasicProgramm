...
MMBasic stellt das aktuelle Datum und die aktuelle Uhrzeit als Zeichenketten zur Verfügung. Dafür stehen indexterm:[Datum und Uhrzeit,DATE$]indexterm:[DATE$]`DATE$` und indexterm:[Datum und Uhrzeit,TIME$]indexterm:[TIME$]`TIME$` bereit.
