...
Viele Programme benötigen indexterm:[Zufallszahlen] Zufallszahlen.
...
MMBasic stellt dafür die Funktion indexterm:[Zufallsfunktionen,RND]indexterm:[RND] `RND` bereit.
...
[source,basic]
----
PRINT indexterm:[Mathematische Funktionen,INT]indexterm:[INT] INT(RND*6)+1
----
